                ...
                <div class="sidebar">
                    ...
                    <div class="main-content">
                        ...
                        <div class="search-bar">
                            <form action="${pageContext.request.contextPath}/violin" method="post">
                                ...
                                <c:forEach var="violin" items="${violins}">
                                    <div class="product-card">
                                        <div class="product-image">
                                            <img src="${pageContext.request.contextPath}/upload/${violin.imageUrl}" alt="${violin.name}" />
                                            <c:if test="${violin.discount.discountId != null}">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="product-price">
                                                <strong><fmt:formatNumber value="${violin.price}"  currencySymbol="VNÐ" groupingUsed="true" pattern="#,##0"/> VNÐ</strong>         
                                            </div>
