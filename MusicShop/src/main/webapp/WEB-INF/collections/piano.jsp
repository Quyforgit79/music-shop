                ...
                <div class="sidebar">
                    ...
                    <div class="main-content">
                        ...
                        <div class="search-bar">
                            <form action="${pageContext.request.contextPath}/piano" method="post">
                                ...
                                <c:forEach var="piano" items="${pianos}">
                                    <div class="product-card">
                                        <div class="product-image">
                                            <img src="${pageContext.request.contextPath}/upload/${piano.imageUrl}" alt="${piano.name}"/>
                                            <c:if test="${piano.discount.discountId != null}">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="product-price">
                                                <strong><fmt:formatNumber value="${piano.price}"  currencySymbol="VNÐ" groupingUsed="true" pattern="#,##0"/> VNÐ</strong>
                                            </div>
